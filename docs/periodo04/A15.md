# A15: Construcción documento anteproyecto
...
2. Transcriba el siguiente ejemplo en su cuaderno:
    ...
    En este ejemplo, se construye un **título de proyecto de grado** relacionado con la idea de **adecuación tecnológica en la sala de informática 115 de la IEJFK**. Primero se responden las 4 preguntas de indagación.
    ...
    > **Respuesta:** Sala 115, Institución Educativa John F. Kennedy
...
3. Identifique y recuerde los contenidos (**marco de antecedentes**) que desarrolló en la plantilla: [ESQUEMA_MARCO_TEORICO.odt](../recursos/recursos/ESQUEMA_MARCO_TEORICO.odt) y tenga presente dicha información para aplicar mas adelante en la construcción de las **referencias del documento de su proyecto de grado**.
...
2. Con los apuntes desarrollados en su cuaderno, diligencie la [Plantilla_ANTEPROYECTO.odt](../recursos/recursos/Plantilla_ANTEPROYECTO.odt).
3. Tome como ejemplo el proyecto de ejemplo: [ANTEPROYECTO_EJEMPLO_SALA115.pdf](../recursos/recursos/ANTEPROYECTO_EJEMPLO_SALA115.pdf).
